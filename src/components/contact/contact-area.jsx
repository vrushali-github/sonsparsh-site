                ...
                <div className="tp-contact-info-wrapper">
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p data-info="mail">
                        <a href="mailto:contact@sonsparsh.com">contact@sonsparsh.com</a>
                      </p>
                      <p data-info="phone">
                        <a href="tel:79 7799 0705">+91 79 7799 0705</a>
                      </p>
                    </div>
                  </div>
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <div className="tp-contact-social-wrapper mt-5">
                        ...
                        <div className="tp-contact-social-icon">
                          <a href="https://www.facebook.com/profile.php?id=61584438907639">
                            <i className="fa-brands fa-facebook-f"></i>
                          </a>
                          <a href="https://www.instagram.com/sonsparsh.jewellery/">
